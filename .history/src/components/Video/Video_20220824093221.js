        ...
        <div className={cx('wrapper')}>
            <div className={cx('info')}>
                ...
                <div className={cx('info-body')}>
                    ...
                    {/* video */}
                    <VideoContent like={data.like_count} nickName={data.nickname} id={data.id} {...data} />
                </div>
            </div>
            <div>
...
// ,
const VideoContent = ({ popular_video, like, nickName, id, comments, share, ...args }) => {
            ...
            <div className={cx('body-video')}>
                ...
                >
                    <video className={cx('video')} ref={videoRef} loop>
                        <source src={popular_video.file_url} />
                    </video>
                </Link>
