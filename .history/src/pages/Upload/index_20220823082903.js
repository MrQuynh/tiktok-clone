...
function Upload() {
    ...
    const [whoValue, setWhovalue] = useState('Public');
    ...
    const handleGetValue = () => {
        setWhovalue(whoRef.current.value);
        // console.log(whoRef.current.innerHTML);
        setWhoView(false);
    };
                                ...
                                <div className={cx('box', 'box-public')} onClick={() => setWhoView(!whoView)}>
                                    ...
                                    {whoView && (
                                        <div className={cx('choose-module')}>
                                            {whoViewList.map((item, index) => (
                                                <div className={cx('choose-item')} key={index}>
                                                    <span className={cx('choose-text')}>{item}</span>
                                                </div>
                                            ))}
                                            {/* <div className={cx('choose-item')}>
                                                <span className={cx('choose-text')} ref={whoRef}>
                                                    Friends
                                                </span>
                                            </div>
                                            <div className={cx('choose-item')}>
