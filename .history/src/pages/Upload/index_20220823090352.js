                                    ...
                                    {whoView && (
                                        <div className={cx('choose-module')}>
                                            {/* {whoViewList.map((item, index) => (
                                                <div className={cx('choose-item')} key={index} onClick={handleGetValue}>
                                                    <span className={cx('choose-text')}>{item}</span>
                                                </div>
                                            ))} */}

                                            <div className={cx('choose-item')} onClick={handleGetValue}>
                                                <span className={cx('choose-text')}>firne</span>
                                            </div>
                                        </div>
                                    )}
                                </div>
