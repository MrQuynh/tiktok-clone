    ...
    useEffect(() => {
        anUserService
            ...
            .then((data) => {
                ...
                setLinkVideo(data.videos.find((video) => video.id === +idVideo).file_url);
            })
    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('body-video')}>
                <div>
                    <ReactPlayer
                        className={cx('player-a')}
                        src="https://v16-webapp.tiktok.com/eae3ca35d6e34d49723b016c2209f4bd/63128cc3/video/tos/useast2a/tos-useast2a-pve-0037c001-aiso/bb7405833ed94a17b87b4f846ae8ca7c/?a=1988&ch=0&cr=0&dr=0&lr=tiktok&cd=0%7C0%7C1%7C0&cv=1&br=4344&bt=2172&cs=0&ds=3&ft=z_piDPWT2NvjVTLZiozfuCYQFAe4nRQjl9-~utOB&mime_type=video_mp4&qs=0&rc=MzU2Mzg4Zzo5Z2Q3NWk3M0Bpajk0bWU6Zjh3ZjMzZjgzM0BjNF5eXzIxXjUxM2NjYjMtYSNwL3FlcjRvZzVgLS1kL2Nzcw%3D%3D&l=20220902170647010244026208255E7C4E&btag=80000"
                        controls={true}
                        play={true}
                    />
                    {/* <video className={cx('video')} ref={videoRef} controls>
                        <source src={videos.v4} />
                    </video> */}
                </div>
                {/* <WatchingVideo linkVideo={linkVideo} /> */}
