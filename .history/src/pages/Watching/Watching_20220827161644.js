...
function Watching() {
    ...
    useEffect(() => {
        anUserService
            ...
            .then((data) => {
                const dataVideo = data?.videos.find((video) => video.id === +idVideo);
                return dataVideo ? setAVideo(dataVideo) : setAVideo([]);
            })
    ...
    const [nickname, avatar, id, name, content, music, like, comments] = [];
    return (
