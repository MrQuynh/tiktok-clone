...
function Watching() {
    ...
    console.log(aVideo);
    // nickName = aVideo.user.nickname;
    // avatar = aVideo.user.avatar;
    // video = aVideo.file_url;

    const { name, nickName, avatar, id, music, comments, file_url, content, like } = { ...aVideo };
    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('body-video')}>
                ...
                <video className={cx('video')} controls loop>
