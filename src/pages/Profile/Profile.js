...
function Profile() {
    ...
    const { name, nickName, avatar, video, viewers, content, followers, following, tick, bio, like } = {
        ...newData,
    };
    return (
        <div className={cx('wrapper')}>
            <div className={cx('info')}>
                ...
                <div className={cx('actions')}>
                    <FaShare className={cx('actions-icon')} />
            ...
            <div className={cx('content')}>
                ...
                {active ? (
                    <div className={cx('video-body')}>
                        <ProfileVideo video={video} viewers={viewers} content={content} />
                    </div>
                ) : (
