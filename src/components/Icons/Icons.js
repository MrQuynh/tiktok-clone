...
export const UpLoadIcon = ({ width = '2.8rem', height = '2.8rem', className }) => (
    ...
    >
        <g>
            <path
                d="M411.448,100.9l-94.7-94.7c-4.2-4.2-9.4-6.2-14.6-6.2h-210.1c-11.4,0-20.8,9.4-20.8,20.8v330.8c0,11.4,9.4,20.8,20.8,20.8
...
export const SearchIcon = ({ width = '2.8rem', height = '2.8rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
// };
// export const MessActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {

// };
// export const ShareActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
